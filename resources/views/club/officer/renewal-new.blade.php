            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-blue-800">Officer Access Granted</h3>
                            <p class="text-sm text-blue-700 mt-1">As a registered officer, you now have full access to club management including renewal applications, member management, and all club functions.</p>
                        </div>
                    </div>
                </div>
