<x-dashboard-layout>
    <x-slot name="title">PSG Council Dashboard</x-slot>

    <!-- Header Section -->
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">PSG Council Dashboard</h1>
                <p class="text-sm text-gray-500 mt-1">Welcome, PSG Council Adviser</p>
            </div>
    ...
    <div class="bg-white border border-gray-200 overflow-hidden">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    <div class="bg-white px-4 py-2 border border-gray-200">
                        ...
                        <span class="text-sm font-semibold text-gray-900">{{ $clubs->total() }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 bg-gray-50 border-b border-gray-200">
            <form method="GET" action="{{ route('psg-council.dashboard') }}" class="flex flex-wrap gap-4">
                ...
                <a href="{{ route('psg-council.dashboard') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 text-sm font-medium transition-colors">
                    Clear
                </a>
            </form>
        </div>
                        ...
                        <div class="p-4">
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100">
                                <div class="flex space-x-2">
                                    <a href="{{ route('psg-council.organization.show', $club) }}"
