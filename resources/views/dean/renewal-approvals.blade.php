<x-dashboard-layout>
    <x-slot name="title">Dean Renewal Approvals</x-slot>

    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Dean Renewal Approvals</h1>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="p-6 border-b border-gray-100">
            ...
            <p class="text-gray-600 mt-1">Renewals waiting for Dean noting</p>
        </div>
                        ...
                        @foreach($renewals as $renewal)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('dean.renewal-approvals.show', $renewal) }}" 
                                    ...
                                    @if(!$renewal->noted_by_dean)
                                        <button type="button"
                                                ...
                                                onclick="openConfirmModal('note', '{{ $renewal->club->name }}', '{{ route('dean.renewal-approvals.note', $renewal) }}', 'POST')">
                                            Note
                                        </button>
                                    @endif
                                </td>
