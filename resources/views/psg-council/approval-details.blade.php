        ...
        <div class="space-y-6">
                    ...
                    <div class="flex items-center">
                        ...
                        @else
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-gray-500">Awaiting Dean endorsement first</p>
                            </div>
                        @endif
                    </div>
            ...
            @if(!$registration->endorsed_by_dean && $registration->status !== 'rejected')
                <div class="bg-gray-50 border border-gray-200 rounded-xl p-6">
                    ...
                    <p class="text-gray-600 mb-2">The application must be endorsed by the Dean first before you can take action.</p>
