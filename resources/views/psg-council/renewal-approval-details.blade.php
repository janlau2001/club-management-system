<x-dashboard-layout>
    <x-slot name="title">PSG Council Adviser Renewal Details</x-slot>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full
                                {{ $renewal->reviewed_by_psg ? 'bg-green-100 text-green-600' : 'bg-blue-100 text-blue-600' }}">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-xs {{ $renewal->reviewed_by_psg ? 'text-green-600' : 'text-blue-600' }}">
                                    {{ $renewal->reviewed_by_psg ? 'Completed' : 'Current Step' }}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <p class="text-sm text-blue-800">
                                    ...
                                    By approving this renewal, you confirm that all required documents have been reviewed and the club meets PSG Council standards.
                                </p>
                            </div>

                            <!-- Approve Form -->
                            <form method="POST" action="{{ route('psg-council.renewal-approvals.note', $renewal) }}" 
                            ...
                            <!-- Reject Form -->
                            <form method="POST" action="{{ route('psg-council.renewal-approvals.reject', $renewal) }}" 
                    ...
                    @else
                        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-green-800">Already Reviewed</h3>
                                    <p class="text-sm text-green-700">
                                        Reviewed by {{ $renewal->reviewed_by_psg_user }} on {{ $renewal->reviewed_by_psg_at->format('M j, Y g:i A') }}
                                    </p>
                                    <p class="text-xs text-green-600 mt-1">→ This renewal will now proceed to Dean for noting.</p>
                                </div>
                            </div>
                        </div>
                    @endif
