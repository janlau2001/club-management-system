    ...
    <div class="min-h-screen">
        ...
        <main class="p-6">
            <div class="max-w-4xl mx-auto space-y-8">
                        ...
                        <div class="flex items-center space-x-6">
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-4 mt-2">
                                    <span class="inline-flex items-center px-3 py-1 text-xs font-medium bg-blue-100 text-blue-800">
                                        {{ $club->name }}
                                    </span>
                ...
                <!-- Settings Tabs -->
                <div x-data="{ activeTab: 'profile' }" class="bg-white border border-gray-200 overflow-hidden">
                    <!-- Tab Navigation -->
                    <div class="border-b border-gray-200">
                        <nav class="flex space-x-8 px-6" aria-label="Tabs">
                            <button @click="activeTab = 'profile'" 
                                    :class="activeTab === 'profile' ? 'border-gray-900 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'" 
                            ...
                            <button @click="activeTab = 'email'" 
                                    :class="activeTab === 'email' ? 'border-gray-900 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'" 
                                    class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors">
                                <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button @click="activeTab = 'password'" 
                                    :class="activeTab === 'password' ? 'border-gray-900 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'" 
                                    class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors">
                                <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="max-w-2xl">
                                ...
                                <form method="POST" action="{{ route('club.member.update-profile') }}" class="space-y-6">
                                    ...
                                    <div class="flex justify-end">
                                        <button type="submit" 
                                                class="px-6 py-3 bg-gray-900 text-white hover:bg-gray-800 transition-colors font-medium focus:outline-none">
                                            Update Profile
                                        </button>
                                    </div>
                                </form>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-900 bg-gray-50 px-3 py-2">{{ $clubUser->email }}</p>
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Student ID</label>
                                    <p class="text-sm text-gray-900 bg-gray-50 px-3 py-2">{{ $clubUser->student_id }}</p>
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Year Level</label>
                                    <p class="text-sm text-gray-900 bg-gray-50 px-3 py-2">{{ $clubUser->year_level }}</p>
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Department</label>
                                    <p class="text-sm text-gray-900 bg-gray-50 px-3 py-2">{{ $clubUser->department }}</p>
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Course</label>
                                    <p class="text-sm text-gray-900 bg-gray-50 px-3 py-2">{{ $clubUser->course ?? 'Not specified' }}</p>
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                                    <p class="text-sm text-gray-900 bg-gray-50 px-3 py-2">{{ $clubUser->formatted_phone ?? 'Not specified' }}</p>
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Club</label>
                                    <p class="text-sm text-gray-900 bg-gray-50 px-3 py-2">{{ $club->name }}</p>
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Member Since</label>
                                    <p class="text-sm text-gray-900 bg-gray-50 px-3 py-2">{{ $clubUser->created_at->format('F j, Y') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-6">
                            <form method="POST" action="{{ route('club.member.update-profile') }}" class="space-y-4">
                                ...
                                <div class="flex justify-end">
                                    <button type="submit" 
                                            class="px-6 py-2 bg-gray-900 text-white hover:bg-gray-800 transition-colors font-medium">
                                        Update Profile
                                    </button>
                                </div>
                            </form>
                    ...
                    <div class="bg-white border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-6">
                            <form method="POST" action="{{ route('club.member.update-password') }}" class="space-y-4">
                                ...
                                <button type="submit" 
                                        class="w-full bg-gray-900 hover:bg-gray-800 text-white font-semibold py-3 px-6 transition-colors focus:outline-none">
                                    Update Password
                                </button>
                            </form>
                        </div>
