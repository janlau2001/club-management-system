<x-dashboard-layout>
    <x-slot name="title">VP Academics Renewal Approvals</x-slot>

    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">VP Academics Renewal Approvals</h1>
        <p class="text-gray-600 mt-2">Review and approve club renewal applications</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="p-6 border-b border-gray-100">
            ...
            <p class="text-gray-600 mt-1">Renewals waiting for VP approval</p>
        </div>
                        ...
                        @foreach($renewals as $renewal)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('vp.renewal-approvals.show', $renewal) }}" 
                                    ...
                                    @if(!$renewal->approved_by_vp)
                                        <button type="button"
                                                ...
                                                onclick="openConfirmModal('approve', '{{ $renewal->club->name }}', '{{ route('vp.renewal-approvals.approve', $renewal) }}', 'POST')">
                                            Approve
                                        </button>
                                    @endif
                                </td>
