<x-dashboard-layout>
    <x-slot name="title">Director Renewal Details</x-slot>
                    ...
                    @if($renewal->rationale)
                        <div>
                            ...
                            <div class="mt-1 p-3 bg-gray-50 rounded-lg">
                                <p class="text-gray-900 text-sm leading-relaxed">{{ $renewal->rationale }}</p>
                            </div>
                        </div>
                    @endif
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full
                                {{ $renewal->endorsed_by_osa ? 'bg-green-100 text-green-600' : 'bg-teal-100 text-teal-600' }}">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-xs {{ $renewal->endorsed_by_osa ? 'text-green-600' : 'text-teal-600' }}">
                                    {{ $renewal->endorsed_by_osa ? 'Completed' : 'Current Step' }}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-teal-50 border border-teal-200 rounded-lg p-4">
                                <p class="text-sm text-teal-800">
                                    <strong>Director Endorsement:</strong>
                                    By endorsing this renewal, you confirm that the club meets all requirements for Student Affairs and Academic Support Services standards.
                                </p>
                            </div>

                            <!-- Endorse Form -->
                            <form method="POST" action="{{ route('director.renewal-approvals.endorse', $renewal) }}" 
                                  x-data="{ showEndorse: false }" class="space-y-3">
                                @csrf
                                <button type="button" @click="showEndorse = true" 
                                ...
                                <div x-show="showEndorse" x-transition class="space-y-3 p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <button type="button" @click="showEndorse = false" 
                            ...
                            <!-- Reject Form -->
                            <form method="POST" action="{{ route('director.renewal-approvals.reject', $renewal) }}" 
                    ...
                    @else
                        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-green-800">Already Endorsed</h3>
