<x-dashboard-layout>
    <x-slot name="title">Director Dashboard</x-slot>
    ...
    <div class="mb-8">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-2 text-lg">Welcome, Director of Student Affairs - Strategic Overview</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl shadow-lg border border-orange-200 p-6 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-xs text-orange-700 mt-1">Awaiting your notation</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl shadow-lg border border-green-200 p-6 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <p class="text-sm font-semibold text-green-600 uppercase tracking-wide">Noted by Me</p>
                    <p class="text-3xl font-bold text-green-900 mt-2">{{ $notedByMe }}</p>
                    <p class="text-xs text-green-700 mt-1">Successfully noted</p>
                </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Strategic oversight of student organizations</p>
                </div>
        ...
        <div class="p-6 bg-gray-50 border-b border-gray-200">
            <form method="GET" action="{{ route('director.dashboard') }}" class="flex flex-wrap gap-4">
                ...
                <select name="department" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                ...
                <a href="{{ route('director.dashboard') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-lg font-medium transition-colors">
                    Clear
                </a>
            </form>
        </div>
