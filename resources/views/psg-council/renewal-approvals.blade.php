<x-dashboard-layout>
    <x-slot name="title">PSG Council Adviser Renewal Approvals</x-slot>

    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">PSG Council Adviser Renewal Approvals</h1>
        <p class="text-gray-600 mt-2">Review and note club renewal applications</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="p-6 border-b border-gray-100">
            ...
            <p class="text-gray-600 mt-1">Renewals waiting for PSG Council Adviser noting</p>
        </div>
                        ...
                        @foreach($renewals as $renewal)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('psg-council.renewal-approvals.show', $renewal) }}" 
                                    ...
                                    @if(!$renewal->reviewed_by_psg)
                                        <button type="button"
                                                ...
                                                onclick="openConfirmModal('note', '{{ $renewal->club->name }}', '{{ route('psg-council.renewal-approvals.note', $renewal) }}', 'POST')">
                                            Note
                                        </button>
                                    @endif
                                </td>
