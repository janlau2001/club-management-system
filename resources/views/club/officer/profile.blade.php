                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center space-x-2 bg-white/20 hover:bg-white/30 text-white px-3 py-2 text-sm font-medium transition-colors border border-white/30">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-xs opacity-75">{{ $clubUser->position ?? 'Officer' }}</p>
                            </div>
                        ...
                        <div x-show="open" @click.away="open = false" 
                            ...
                            <!-- Menu Items -->
                            <a href="{{ route('club.officer.profile') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 bg-gray-50">
                    ...
                    <div class="bg-gray-50 px-6 py-8 border-b border-gray-200">
                        <div class="flex items-center space-x-6">
                            ...
                            <div>
                                ...
                                <p class="text-lg text-gray-600">{{ $clubUser->position ?? 'Officer' }}</p>
                    ...
                    <div class="p-6">
                        ...
                        <div x-show="activeTab === 'profile'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                            <div class="max-w-2xl">
                                ...
                                <form method="POST" action="{{ route('club.officer.update-profile') }}" class="space-y-6">
                                    @csrf
                                    @method('PUT')
                        ...
                        <div x-show="activeTab === 'email'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                            <div class="max-w-2xl">
                                ...
                                <form method="POST" action="{{ route('club.officer.update-email') }}" class="space-y-6">
                                    @csrf
                                    @method('PUT')
                        ...
                        <div x-show="activeTab === 'password'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                            <div class="max-w-2xl">
                                ...
                                <form method="POST" action="{{ route('club.officer.update-password') }}" class="space-y-6">
                                    @csrf
