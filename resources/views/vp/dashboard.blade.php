<x-dashboard-layout>
    <x-slot name="title">VP for Academics Dashboard</x-slot>

    <!-- Header Section -->
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">VP for Academics Dashboard</h1>
                <p class="text-sm text-gray-500 mt-1">Welcome, Vice President - Academic oversight</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white border border-gray-200 p-5">
            <div class="flex flex-col">
                ...
                <p class="text-xs text-gray-500 mt-1">Awaiting your approval</p>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 p-5">
            <div class="flex flex-col">
                <p class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">APPROVED BY ME</p>
                <p class="text-3xl font-semibold text-gray-900">{{ $approvedByMe }}</p>
    ...
    <div class="bg-white border border-gray-200 overflow-hidden">
        ...
        <div class="p-6 bg-gray-50 border-b border-gray-200">
            <form method="GET" action="{{ route('vp.dashboard') }}" class="flex flex-wrap gap-4">
                ...
                <a href="{{ route('vp.dashboard') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 text-sm font-medium transition-colors">
                    Clear
                </a>
            </form>
        </div>
                        ...
                        <div class="p-4">
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100">
                                <div class="flex space-x-2">
                                    <a href="{{ route('vp.organization.show', $club) }}"
