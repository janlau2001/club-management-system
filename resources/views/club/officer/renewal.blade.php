    ...
    <div class="min-h-screen">
        ...
        <main class="p-6">
            <div class="max-w-4xl mx-auto">
                ...
                <!-- Renewal Window Status Banner -->
                @if($isClosed)
                    <div class="mb-6 bg-red-50 border border-red-200 px-5 py-4 flex items-start gap-3">
                        ...
                        <div>
                            <p class="font-semibold text-red-800">Renewal Window Closed</p>
                            <p class="text-sm text-red-700 mt-0.5">The renewal period (Aug 1–31) and grace period (Sep 1–10) have passed. Submissions are not accepted until August 1 next year.</p>
                        </div>
                    </div>
                @elseif($isGracePeriod)
                    <div class="mb-6 bg-yellow-50 border border-yellow-300 px-5 py-4 flex items-start gap-3">
                        <svg class="w-5 h-5 text-yellow-600 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01M10.29 3.86L1.82 18a1 1 0 00.86 1.5h18.64a1 1 0 00.86-1.5L13.71 3.86a2 2 0 00-3.42 0z"/>
                        </svg>
                        <div>
                            <p class="font-semibold text-yellow-800">Grace Period — Ends September 10</p>
                            <p class="text-sm text-yellow-700 mt-0.5">The standard renewal window (Aug 31) has closed. You may still submit during this grace period, but your application may be subject to review. Submit as soon as possible.</p>
                        </div>
                    </div>
                @elseif($isWarningSoon)
                    <div class="mb-6 bg-orange-50 border border-orange-300 px-5 py-4 flex items-start gap-3">
                        <svg class="w-5 h-5 text-orange-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01M10.29 3.86L1.82 18a1 1 0 00.86 1.5h18.64a1 1 0 00.86-1.5L13.71 3.86a2 2 0 00-3.42 0z"/>
                        </svg>
                        <div>
                            <p class="font-semibold text-orange-800">Renewal Deadline Approaching — August 31</p>
                            <p class="text-sm text-orange-700 mt-0.5">Less than 10 days remain. Submit your renewal now to avoid interruption to club operations.</p>
                        </div>
                    </div>
                @elseif($isWindowOpen)
                    <div class="mb-6 bg-green-50 border border-green-200 px-5 py-4 flex items-start gap-3">
                        <svg class="w-5 h-5 text-green-600 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <div>
                            <p class="font-semibold text-green-800">Renewal Window Open</p>
                            <p class="text-sm text-green-700 mt-0.5">The annual renewal window is open from August 1 to August 31. Submit your renewal application below.</p>
                        </div>
                    </div>
                @else
                    <div class="mb-6 bg-gray-50 border border-gray-200 px-5 py-4 flex items-start gap-3">
                        <svg class="w-5 h-5 text-gray-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <div>
                            <p class="font-semibold text-gray-700">Renewal Window Not Yet Open</p>
                            <p class="text-sm text-gray-600 mt-0.5">The renewal window opens on <strong>August 1</strong> each year and closes on August 31. Check back then to submit your renewal.</p>
                        </div>
                    </div>
                @endif
                        ...
                        <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                            ...
                            @if($isClosed)
                                <button type="button" disabled
                                        class="px-6 py-2 bg-gray-300 text-gray-500 font-medium cursor-not-allowed" title="Renewal window is closed">
                                    Submission Closed
                                </button>
                            @else
                                <button type="submit" 
