...
<head>
    ...
    <title>View Members - {{ $club->name }}</title>
        ...
        <header class="bg-gradient-to-r from-[#29553c] to-[#031a0a] shadow-lg">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-white">View Members</h1>
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $clubUsers->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900">{{ $clubUsers->where('role', 'officer')->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600">Advisers</p>
                            <p class="text-2xl font-bold text-gray-900">{{ $clubUsers->where('role', 'adviser')->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600">Regular Members</p>
                            <p class="text-2xl font-bold text-gray-900">{{ $clubUsers->where('role', 'member')->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900">Club Members</h2>
                    <p class="text-sm text-gray-600 mt-1">View all members and officers of {{ $club->name }}</p>
                </div>
                ...
                @else
                    <div class="px-6 py-12 text-center">
                        ...
                        <p class="mt-1 text-sm text-gray-500">No members have been added to this club yet.</p>
                    </div>
                @endif
            </div>

            <!-- Information Note for Regular Officers -->
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-sm text-blue-700 mt-1">
                            As a {{ $clubUser->getDisplayRole() }}, you can view all club members but cannot add, edit, or remove members. 
                            Only Presidents, Vice Presidents, and Advisers have member management privileges.
                        </p>
                    </div>
                </div>
            </div>
