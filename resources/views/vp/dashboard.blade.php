<x-dashboard-layout>
    <x-slot name="title">VP Academics Dashboard</x-slot>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-2 text-lg">Welcome, VP Academics - Academic Excellence Overview</p>
            </div>
        ...
        <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl shadow-lg border border-orange-200 p-6 hover:shadow-xl transition-all duration-300">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-xs text-orange-700 mt-1">Awaiting your approval</p>
                </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Monitor academic organizations and clubs</p>
                </div>
        ...
        <div class="p-6 bg-gray-50 border-b border-gray-200">
            <form method="GET" action="{{ route('vp.dashboard') }}" class="flex flex-wrap gap-4">
                ...
                <a href="{{ route('vp.dashboard') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-lg font-medium transition-colors">
                    Clear
                </a>
            </form>
        </div>
