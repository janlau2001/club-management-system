    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('director.organization.export-pdf', $club->id) }}"
                ...
                <a href="{{ route('director.dashboard') }}" class="text-green-600 hover:text-green-800">← Back to Dashboard</a>
            </div>
        </div>
        ...
        <!-- Members Section -->
        @if($club->members && $club->members->count() > 0)
            <div class="bg-white shadow rounded-lg p-6">
                <h2 class="text-lg font-semibold mb-4">Club Members</h2>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
