<x-dashboard-layout>
    <x-slot name="title">Dean Approvals</x-slot>

    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Dean Approvals</h1>
        <p class="text-gray-600 mt-2">Review and endorse club registration applications</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
        <div class="border-b border-gray-200">
            <nav class="flex -mb-px">
                <!-- Pending Tab -->
                <a href="{{ route('dean.approvals', ['status' => 'pending']) }}" 
                ...
                <!-- Approved Tab -->
                <a href="{{ route('dean.approvals', ['status' => 'approved']) }}" 
                   class="group inline-flex items-center py-4 px-6 border-b-2 font-medium text-sm transition-colors
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="p-6 border-b border-gray-100">
            <h2 class="text-xl font-semibold text-gray-900">Dean Endorsements</h2>
            <p class="text-gray-600 mt-1">Applications ready for Dean review (all submitted applications)</p>
        </div>
                        ...
                        @foreach($registrations as $registration)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('dean.approvals.show', $registration) }}" 
    ...
    <div id="approveModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                ...
                <div class="mt-4 mb-6">
                    <p class="text-sm text-gray-500 mb-4" id="approveMessage">Are you sure you want to endorse this registration?</p>
                    ...
                    <div class="flex items-center text-xs text-red-600">
                        ...
                        <span>Verifying as: <strong>Dean</strong></span>
                    </div>
                </div>
    ...
    <script>
        function openApproveModal(clubName, url) {
            document.getElementById('approveMessage').textContent = 'Are you sure you want to endorse the registration for "' + clubName + '"?';
