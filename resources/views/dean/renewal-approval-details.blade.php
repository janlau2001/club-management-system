<x-dashboard-layout>
    <x-slot name="title">Dean Renewal Details</x-slot>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full
                                {{ $renewal->noted_by_dean ? 'bg-green-100 text-green-600' : 'bg-orange-100 text-orange-600' }}">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-xs {{ $renewal->noted_by_dean ? 'text-green-600' : 'text-orange-600' }}">
                                    {{ $renewal->noted_by_dean ? 'Completed' : 'Current Step' }}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-orange-50 border border-orange-200 rounded-lg p-4">
                                <p class="text-sm text-orange-800">
                                    <strong>Dean Noting:</strong>
                                    By noting this renewal, you acknowledge that all documentation has been reviewed and the club renewal is ready to proceed to the next approval stage.
                                </p>
                            </div>

                            <!-- Note/Approve Form -->
                            <form method="POST" action="{{ route('dean.renewal-approvals.note', $renewal) }}" 
                                  x-data="{ showNote: false }" class="space-y-3">
                                @csrf
                                ...
                                <div x-show="showNote" x-transition class="space-y-3 p-4 bg-gray-50 rounded-lg">
                            ...
                            <!-- Reject Form -->
                            <form method="POST" action="{{ route('dean.renewal-approvals.reject', $renewal) }}" 
                    ...
                    @else
                        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-green-800">Already Noted</h3>
