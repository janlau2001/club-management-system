                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center">
                        ...
                        @elseif($registration->approved_by_psg_council)
                            ...
                            <div class="ml-3">
                                <p class="text-sm font-medium text-yellow-900">Step 3: NOTED BY Director</p>
                                <p class="text-sm text-yellow-700">Current Step - Pending</p>
                            </div>
                        @else
                            <div class="flex-shrink-0">
                                <div class="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center">
            ...
            @if(!$registration->approved_by_psg_council)
                <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                    <div class="flex items-center space-x-3 mb-3">
                        ...
                        <h3 class="text-lg font-semibold text-yellow-900">Waiting for PSG Council Approval</h3>
                    </div>
                    <p class="text-yellow-800">This application needs to be approved by the PSG Council before the Director can review it.</p>
                </div>
            @endif
