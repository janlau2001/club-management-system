<x-dashboard-layout>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">Director Dashboard</h1>
                <p class="text-sm text-gray-500 mt-1">Welcome, Director - Student Affairs and Academic Support Services</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white border border-gray-200 p-5">
            <div class="flex flex-col">
                ...
                <p class="text-xs text-gray-500 mt-1">Awaiting your notation</p>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 p-5">
            <div class="flex flex-col">
                <p class="text-xs font-medium text-gray-500 uppercase tracking-wide mb-2">NOTED BY ME</p>
                <p class="text-3xl font-semibold text-gray-900">{{ $notedByMe }}</p>
                <p class="text-xs text-gray-500 mt-1">Successfully noted</p>
            </div>
        </div>
    ...
    <div class="bg-white border border-gray-200 overflow-hidden">
        ...
        <div class="p-6 bg-gray-50 border-b border-gray-200">
            <form method="GET" action="{{ route('director.dashboard') }}" class="flex flex-wrap gap-4">
                ...
                <a href="{{ route('director.dashboard') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 text-sm font-medium transition-colors">
                    Clear
                </a>
            </form>
        </div>
